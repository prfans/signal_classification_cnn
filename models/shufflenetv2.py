...
def channel_shuffle(x, groups):
    ...
    channels_per_group = channels // groups #int(channels / groups)
    ...
    def __init__(self, in_channels, out_channels, stride):
        ...
        if stride != 1 or in_channels != out_channels:
            self.residual = nn.Sequential(
                ...
                nn.Conv1d(in_channels, in_channels, 3, stride=stride, padding=1, groups=in_channels),
                nn.BatchNorm1d(in_channels),
                nn.Conv1d(in_channels, int(out_channels / 2), 1),
...
if __name__ == "__main__":
    ...
    onnx_export_name = 'shufflenetv2.onnx'
